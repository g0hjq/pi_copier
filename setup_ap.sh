...
nmcli con add type wifi ifname wlan0 mode ap con-name Copier_AP ssid Copier2_AP autoconnect yes
...
nmcli con modify Copier_AP ipv4.method shared ipv4.address 192.168.4.2/24
